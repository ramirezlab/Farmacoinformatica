...
1. Para iniciar deben primero deben acceder a la maquina *Chernobyl* del RamirezLab.
   Debemos escoger un puerto para abrir la interfaz gráfica, para esto se escogemos un número **único** de cuatro cifras (_####_) que se usará en adelante. El comando de acceso es:
